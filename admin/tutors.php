...
if ($op == 'delete') {
    $id = $_GET['id'];
    $sql1   = "select foto from tutor where id = '$id'";
    $q1     = mysqli_query($koneksi,$sql1);
    $r1     = mysqli_fetch_array($q1);
    @unlink("../gambar/".$r1['foto']);
 
    $sql1   = "delete from tutor where id = '$id'";
    $q1     = mysqli_query($koneksi, $sql1);
    if ($q1) {
...
<p>
    <a href="tutors_input.php">
        <input type="button" class="btn btn-primary" value="Buat Tutor Baru" />
    </a>
</p>
<?php
if ($sukses) {
...
<table class="table table-striped">
    ...
    <tbody>
        ...
        $sql1   = "select * from tutor $sqltambahan";
        ...
        ?>
            <tr>
                ...
                <td><img src="../gambar/<?php echo tutor_foto($r1['id'])?>" style="max-height:100px;max-width:100px"/></td>
