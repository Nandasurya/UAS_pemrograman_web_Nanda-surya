...
if($id != ""){
    $sql1   = "select * from tutor where id = '$id'";
...
if (isset($_POST['simpan'])) {
    ...
    if (empty($error)) {
        if($foto_name){
            ...
            $foto_name = "tutor_".time()."_".$foto_name;
        ...
        if($id != ""){
            $sql1   = "update tutor set nama = '$nama',foto='$foto_name',isi='$isi',tgl_isi=now() where id = '$id'";
        }else{
            $sql1       = "insert into tutor(nama,foto,isi) values ('$nama','$foto_name','$isi')";
        }
...
?>
<h1>Halaman Admin Input Data Tutor</h1>
<div class="mb-3 row">
    <a href="tutors.php">
        << Kembali ke halaman admin Tutor</a>
</div>
<?php
if ($error) {
?>
